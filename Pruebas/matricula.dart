  ...
  Widget _buildCopilotView(ThemePalette p) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildHeaderSection('Portal Pilot Copilot', 'Asistente inteligente para gestión administrativa escolar.',
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('PORTAL PILOT', style: GoogleFonts.syne(fontSize: 17, fontWeight: FontWeight.w900, color: p.textPrimary, letterSpacing: 1.2),
                            overflow: TextOverflow.ellipsis),
                        Text('v2.4.1 · Escolar', style: GoogleFonts.spaceGrotesk(fontSize: 10, color: p.textMuted, letterSpacing: 0.6, fontWeight: FontWeight.w600)),
                      ],
                    ),
                  ),
                ],
...
class ThemePalette {
  ...
  Color get bgSecondary => isDark ? const Color(0xFF080808) : const Color(0xFFFFFFFF);
  Color get bgTertiary => isDark ? const Color(0xFF0F0F0F) : const Color(0xFFEDEDED);
  ...
  Color get textPrimary => isDark ? const Color(0xFFFFFFFF) : const Color(0xFF0A0A0A);
  Color get textSecondary => isDark ? const Color(0xFFE5E5E5) : const Color(0xFF1A1A1A);
  ...
  Color get borderLight => isDark ? const Color(0x29FFFFFF) : const Color(0x1F000000);
}
