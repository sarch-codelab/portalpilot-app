...
class _EmployeeLoginScreenState extends State<EmployeeLoginScreen> {
  ...
  void initState() {
    super.initState();
    // Datos demo
    _companyCodeController.text = 'EMPDEMO01';
    _emailController.text = 'operador@empresa.com';
    _passwordController.text = 'Oper123!';
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  FadeInDown(
                    ...
                    child: Text(
                      'Acceso para empleados y operadores',
                      style: GoogleFonts.inter(
                        fontSize: 12,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              'Ingresa con tu código de empresa',
                              style: GoogleFonts.inter(
                                fontSize: 12,
                                color: Colors.white54,
                              ),
                            ...
                            Center(
                              child: Text(
                                '¿No tienes código? Contacta a tu administrador',
                                style: GoogleFonts.inter(
                                  fontSize: 10,
