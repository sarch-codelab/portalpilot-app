...
class _FidelizacionState extends State<Fidelizacion> {
  List<Map<String, dynamic>> _programas = [
    {
      ...
      'nombre': 'Programa Oro',
      'nivel': 'Premium',
      'beneficios': 'Descuento 15%, Puntos dobles',
      'clientes': 50,
    },
    {
      'id': '2',
      'nombre': 'Programa Plata',
      'nivel': 'Regular',
      'beneficios': 'Descuento 10%, Puntos normales',
      'clientes': 150,
    },
    {
      'id': '3',
      'nombre': 'Programa Bronce',
      'nivel': 'Basico',
      'beneficios': 'Descuento 5%, Sin puntos extra',
      'clientes': 300,
    },
  ];
  ...
  Widget _buildProgramaCard(
    Map<String, dynamic> programa,
    ThemePalette palette,
  ) {
    final nivelColor = programa['nivel'] == 'Premium'
        ? const Color(0xFF10B981)
        : programa['nivel'] == 'Regular'
