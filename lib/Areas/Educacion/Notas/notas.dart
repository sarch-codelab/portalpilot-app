...
class _NotasScreenState extends State<NotasScreen> with TickerProviderStateMixin {
  ...
  Future<void> _cargarDatosUsuario() async {
    ...
    setState(() {
      _nombreUsuario = prefs.getString('user_nombre') ?? 'Prof. García';
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: p.accentPurple.withOpacity(0.1),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: p.accentPurple.withOpacity(0.35), blurRadius: 20, offset: const Offset(0, 8)),
              ],
            ),
  ...
  Widget _buildFiltrosCascada(ThemePalette p) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.black.withOpacity(p.isDark ? 0.3 : 0.06), blurRadius: 20, offset: const Offset(0, 8)),
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
                ...
                child: _buildDropdownFiltro(
                  ...
                  onChanged: (v) {
                    setState(() {
                      ...
                      _notasEditadas = Map.from(_notasPrueba);
                    });
                  },
                  p: p,
                ),
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(10),
            border: Border.all(color: enabled ? p.borderLight : p.borderLight.withOpacity(0.5)),
          ),
  ...
  Widget _buildPeriodoCerradoBanner(ThemePalette p) {
    return Container(
      ...
      padding: const EdgeInsets.all(14),
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [p.errorRed.withOpacity(0.15), p.errorRed.withOpacity(0.05)]),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: p.errorRed.withOpacity(0.4)),
      ),
      child: Row(
        children: [
          ...
          TextButton(
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: const Text('📧 Solicitud enviada a dirección'),
              ...
              return Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(color: p.accentPurple.withOpacity(0.2)),
                  ),
                  child: Column(
                    children: [
                      Text(rubro.nombre,
            ...
            return ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('✏️ Editor de rúbricas próximamente'),
                      backgroundColor: p.accentPurple,
                      behavior: SnackBarBehavior.floating,
                    ),
                  );
                ...
                child: Column(
                  children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 12),
                            decoration: BoxDecoration(
                              gradient: LinearGradient(colors: [p.accentPurple.withOpacity(0.15), p.accentPurple.withOpacity(0.05)]),
                              border: Border(left: BorderSide(color: p.accentPurple.withOpacity(0.3))),
                            ),
                            child: Column(
                              children: [
                                Text('PROMEDIO',
                    ...
                    ..._alumnos.asMap().entries.map((entry) {
                      ...
                      return Container(
                        decoration: BoxDecoration(
                          color: index.isEven ? p.cardColor : p.bgTertiary.withOpacity(0.3),
                          border: Border(bottom: BorderSide(color: p.borderLight)),
                        ),
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(colors: [
                                  _getColorNota(promedio, p).withOpacity(0.15),
                                  _getColorNota(promedio, p).withOpacity(0.05),
                                ]),
                                border: Border(left: BorderSide(color: p.accentPurple.withOpacity(0.3))),
                              ),
                              child: Center(
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                                  decoration: BoxDecoration(
                                    color: _getColorNota(promedio, p).withOpacity(0.15),
                                    borderRadius: BorderRadius.circular(8),
                                    border: Border.all(color: _getColorNota(promedio, p).withOpacity(0.3)),
                                  ),
                                  child: Text(
  ...
  Widget _buildCeldaNota({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: nota != null ? _getColorNota(nota, p).withOpacity(0.08) : Colors.transparent,
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: nota != null ? _getColorNota(nota, p).withOpacity(0.3) : p.borderLight,
        ),
      ),
      child: TextField(
        ...
        onTap: () {
          if (_periodoCerrado) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: const Text('🔒 Periodo cerrado. No se puede modificar.'),
          ...
          Expanded(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12),
                boxShadow: [
                  BoxShadow(color: p.accentPurple.withOpacity(0.4), blurRadius: 16, offset: const Offset(0, 6)),
                ],
              ),
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text('✓ ${_notasEditadas.length} calificaciones guardadas'),
            ],
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [p.accentPurple.withOpacity(0.15), p.accentPurpleDark.withOpacity(0.05)],
              ),
              borderRadius: BorderRadius.circular(20),
              border: Border.all(color: p.accentPurple.withOpacity(0.3)),
            ),
            child: Row(
              children: [
                ...
                Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
                    color: _getColorNota(promedioGeneral, p).withOpacity(0.15),
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(color: _getColorNota(promedioGeneral, p).withOpacity(0.4)),
                  ),
                  child: Column(
                    children: [
                      Text('PROMEDIO',
          ...
          ...calificaciones.entries.map((entry) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: p.borderLight),
                boxShadow: [
                  BoxShadow(color: Colors.black.withOpacity(p.isDark ? 0.2 : 0.04), blurRadius: 12, offset: const Offset(0, 4)),
                ],
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(colors: [
                            _getColorNota(promedio, p).withOpacity(0.2),
                            _getColorNota(promedio, p).withOpacity(0.05),
                          ]),
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(color: _getColorNota(promedio, p).withOpacity(0.4)),
                        ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  promedioGeneral >= 60 
                      ? p.successGreen.withOpacity(0.15)
                      : p.errorRed.withOpacity(0.15),
                  (promedioGeneral >= 60 ? p.successGreen : p.errorRed).withOpacity(0.05),
                ],
              ),
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                color: (promedioGeneral >= 60 ? p.successGreen : p.errorRed).withOpacity(0.4),
              ),
            ),
            child: Row(
              children: [
